...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name='convenience',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='products.convenience'),
        ),
        migrations.AddField(
            model_name='roomconvenience',
            name='room',
        ...
        migrations.AddField(
            model_name='roomconvenience',
            name='service_type',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='products.servicetype'),
        ),
        migrations.AddField(
            model_name='room',
            name='convenience',
        ...
        migrations.AddField(
            model_name='review',
            name='dinning',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='products.dinning'),
        ),
        migrations.AddField(
            model_name='review',
            name='user',
